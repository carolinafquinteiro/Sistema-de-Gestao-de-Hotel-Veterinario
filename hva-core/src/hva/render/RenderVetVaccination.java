 ...
 */
public class RenderVetVaccination implements HotelVisitor {

    // StringBuilder to store the generated output as a string
    private StringBuilder output = new StringBuilder();
    private String  targetVetId;

    public RenderVetVaccination( String targetVetId) {
        this.targetVetId = targetVetId;
    }
    /**
    ...
    public void visit(Hotel hotel) {
        ...
        for (VaccinationRecord r : hotel.getRecords()) {
            String vet = r.getVeterinarianId();
            if (vet.equals(targetVetId)){
                total ++;
            }
        }
