 ...
 */
public class RenderAnimalVaccination implements HotelVisitor {

    // StringBuilder to store the generated output as a string
    private StringBuilder output = new StringBuilder();
    private String  targetAnimalId;

    public RenderAnimalVaccination( String targetAnimalId) {
    ...
    public void visit(Hotel hotel) {
        ...
        for (VaccinationRecord r : hotel.getRecords()) {
            String animal = r.getAnimalId();
            if (animal.equals(targetAnimalId)){
                total ++;
            }
        }
        for (VaccinationRecord v : hotel.getRecords()) {
            if (v != null) {
                ...
                String idanimal = v.getAnimalId();
                if (idanimal.equals(targetAnimalId)){
